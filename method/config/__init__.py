...
def add_method_arguments(parser):
    parser.add_argument('--en_pop_dim', type=int, default=10)
    parser.add_argument('--de_pop_dim', type=int, default=10)
    ...
    # misc
    parser.add_argument("--run_prefix", type=str, default="table_lack_0825-11")
    ...
    parser.add_argument("--wandb_entity", type=str, default="2779215748")
    parser.add_argument("--wandb_project", type=str, default="furniture")
    ...
    parser.add_argument(
        "--batch_size1", type=int, default=128, help="the sample batch size"
    )
...
def add_off_policy_arguments(parser):
    parser.add_argument(
        "--buffer_size", type=int, default=int(1e4), help="the size of the buffer"
    )
...
def add_sac_arguments(parser):
    ...
    parser.set_defaults(buffer_size=10000)
